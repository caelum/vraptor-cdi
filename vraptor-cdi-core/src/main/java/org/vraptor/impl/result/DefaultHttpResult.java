...
import org.vraptor.result.HttpResult;
import org.vraptor.result.ResultException;
import org.vraptor.result.StatusResult;
...
public class DefaultHttpResult implements HttpResult {
	...
	public DefaultHttpResult(HttpServletResponse response, StatusResult status) {
